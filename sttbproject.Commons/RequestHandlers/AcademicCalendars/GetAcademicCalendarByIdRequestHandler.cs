...
public class GetAcademicCalendarByIdRequestHandler : IRequestHandler<GetAcademicCalendarByIdRequest, AcademicCalendarDetailResponse>
{
    ...
    public GetAcademicCalendarByIdRequestHandler(SttbprojectContext context, ILogger<GetAcademicCalendarByIdRequestHandler> logger)
    {
        _context = context;
        _logger = logger;
    }
    ...
    public static AcademicCalendarDetailResponse MapToDetailResponse(AcademicCalendar item)
    {
